    ...
    <div class="container ">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8" style="background:#f1f1f1">
                ...
                <div>
                    <p>Year:<?php echo $result_row['movie_year'] ?></p>
                    <p>Book_Rating:<?php echo $result_row['movie_rating'] ?></p>
                    <p>Book_name:<?php echo $result_row['movie_bio'] ?></p>
                    <div class="row">
                        <p class="text-center fs-3 fs-bold">User Reviews</p>
                        <?php for ($i = 0; $i < 5; $i++ ) :
                        ...
                        <p>Review: <br /><?php echo $review_result_row['review_content'] ?></p>
                        <?php echo '</div>';
                        endwhile; endfor;  ?>
                    </div>
                </div>
            ...
            <div class="actions my-3">
                <div class="d-flex justify-content-center">
                    <a class="btn btn-primary me-1" href="addreview.php?id=<?php echo $result_row['movie_id'] ?>"
                    ...
                    <a class="btn btn-warning me-1 actBtnOne" href="../<?php echo $result_row['movie_pdf'];?>#toolbar=0"
                        role="button" target="_blank">Read Book
                        <i class="fa-solid fa-book-open-reader icn"></i>
                    </a>
                    <!-- <button type="button" class="btn btn-warning actBtn">Read Book
                        <i class="fa-solid fa-book-open-reader icn"></i>
                    </button> -->
                    <a class="btn btn-warning me-1 actBtn" href="../bookpdf<?php echo $result_row['mobile_pdf'];?>"
                        role="button" target="_blank">Read Book
                        <i class="fa-solid fa-book-open-reader icn"></i>
                    </a>
                    <?php if ($role == 1) : ?>
